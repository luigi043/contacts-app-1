    ...
    let contacts: Contact[] = [
      {
        ...
        dateOfBirth: new Date('1994/05/05'),//'1994-05-05T06:00:00.000Z'
        favoritesRanking: 1,
      ...
      },
      {
        ...
        favoritesRanking: 0,
        phones: [
          { phoneNumber: '555-877-5678', phoneType: 'mobile', preferred: false },
          { phoneNumber: '666-777-5654', phoneType: 'work', preferred: false }
        ],
        address: {
